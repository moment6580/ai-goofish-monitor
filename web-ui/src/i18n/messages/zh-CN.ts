...
const zhCN = {
  ...
  results: {
    ...
    insights: {
      ...
      historyMax: '历史最高价：',
      panelBadge: '行情分析',
      sampleTotal: '样本总量 {count} 件',
      expandPanel: '展开行情',
      collapsePanel: '收起行情',
      trendDigestTitle: '市场走势速读',
      priceRangeTitle: '价格统计区间',
    },
    chart: {
      avgPrice: '均价',
      medianPrice: '中位数',
    ...
    card: {
      ...
      block: '屏蔽',
      unblock: '取消屏蔽',
      belowMarketAvg: '低均价 ¥{amount}',
      wantCount: '{count}人想要',
      marketAvgShort: '均价 ¥{price}',
      matchScore: '匹配度',
    },
  },
  logs: {
