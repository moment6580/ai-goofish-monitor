...
const enUS = {
  ...
  sidebar: {
    ...
    groupMonitoring: 'Monitoring & Discovery',
    groupControl: 'Control & Configuration',
    liveEngine: 'Live Engine',
    engineTitle: 'Xianyu Deal Monitor',
  },
  login: {
    title: 'Sign In',
  ...
  results: {
    ...
    insights: {
      ...
      historyMax: 'Historical high:',
      panelBadge: 'Insights',
      sampleTotal: '{count} samples total',
      expandPanel: 'Show insights',
      collapsePanel: 'Hide insights',
      trendDigestTitle: 'Market Trend Digest',
      priceRangeTitle: 'Price Range Stats',
    },
    chart: {
      avgPrice: 'Average',
      medianPrice: 'Median',
    ...
    card: {
      ...
      block: 'Block',
      unblock: 'Unblock',
      belowMarketAvg: '¥{amount} under avg',
      wantCount: '{count} wants',
      marketAvgShort: 'Avg ¥{price}',
      matchScore: 'Match',
    },
  },
  logs: {
    ...
    waitingOutput: 'Waiting for spider output...',
